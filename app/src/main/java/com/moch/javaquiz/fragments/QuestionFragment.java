...
public class QuestionFragment extends Fragment {
    ...
    private void viewPreviousAnswer() {
        ...
        if (questionCounter > 1) {
            ...
            if (answers[questionCounter - 1][0] == 1) {
                cb1.setChecked(true);
            } else {
                cb1.setChecked(false);
            }
            if (answers[questionCounter - 1][1] == 1) {
                cb2.setChecked(true);
            } else {
                cb2.setChecked(false);
            }
            if (answers[questionCounter - 1][2] == 1) {
                cb3.setChecked(true);
            } else {
                cb3.setChecked(false);
            }
            if (answers[questionCounter - 1][3] == 1) {
                cb4.setChecked(true);
            } else {
                cb4.setChecked(false);
            }
